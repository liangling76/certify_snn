...
class CIFAR_CONV1(torch.nn.Module):
    def __init__(self):
        super(CIFAR_CONV1, self).__init__()

        self.conv1  = sbl.BoundConv2d(3, 128, stride=2)
        self.mem_c1 = sbl.BoundMemUpdate()

        self.conv2  = sbl.BoundConv2d(128, 256, stride=2)
        self.mem_c2 = sbl.BoundMemUpdate()
        
        self.flat   = sbl.BoundFlatten()

        self.fc1    = sbl.BoundLinear(8 * 8 * 256, 512)
        self.mem_f1 = sbl.BoundMemUpdate()

        self.fc2    = sbl.BoundLinear(512, 10)
...
class CIFAR_CONV2(torch.nn.Module):
    def __init__(self):
        super(CIFAR_CONV2, self).__init__()

        self.conv1  = sbl.BoundConv2d(3, 128, stride=2)
        self.mem_c1 = sbl.BoundMemUpdate()

        self.conv2  = sbl.BoundConv2d(128, 128, stride=2)
        self.mem_c2 = sbl.BoundMemUpdate()
        
        self.flat   = sbl.BoundFlatten()

        self.fc1    = sbl.BoundLinear(8 * 8 * 128, 512)
        self.mem_f1 = sbl.BoundMemUpdate()
