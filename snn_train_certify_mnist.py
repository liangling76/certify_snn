...
checkpoint_org = './ckpt/mnist_' + model + '.pth.tar'
...
for epoch in range(num_epochs + finetune_epochs + 1):
    ...
    if if_train and epoch > 0:
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            # loss2.backward() #crown 1
            # (loss1 * 0.6 + loss2 * 0.4).backward() #crown 3
            # (loss1 * 0.3 + loss2 * 0.7).backward() #crown 2
            (loss1 * 0.4 + loss2 * 0.6).backward() #crown 1
