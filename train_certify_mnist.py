...
checkpoint_org = './ckpt/model/mnist_' + model + '.pth.tar'

checkpoint_new = './ckpt/model_mnist/' + model + '_T_' + time_step_certify + '_eps_' + max_eps +  '.pth.tar'
checkpoint_ibp = './ckpt/model_mnist/' + model + '_T_' + time_step_certify + '_eps_' + max_eps +  '_ibp.pth.tar'
checkpoint_crown = './ckpt/model_mnist/' + model + '_T_' + time_step_certify + '_eps_' + max_eps +  '_crown.pth.tar'
checkpoint_analyze = './ckpt/model_mnist/analyze_' + model + '_T_' + time_step_certify + '_eps_' + max_eps +  '.pth.tar'
